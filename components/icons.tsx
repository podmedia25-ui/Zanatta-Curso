...
export const IZLogo = ({ className }: { className?: string }) => (
    <svg
        className={className}
        viewBox="0 0 100 100"
        xmlns="http://www.w3.org/2000/svg"
        aria-label="Instituto Zanatta Logo"
    >
        <circle cx="50" cy="50" r="48" fill="#0ea5e9" />
        <circle cx="50" cy="50" r="44" fill="white" />
        <g transform="translate(0, 2)">
            {/* I */}
            <rect x="35" y="28" width="5" height="5" rx="2" fill="#0ea5e9" />
            <rect x="35" y="40" width="5" height="32" rx="2" fill="#0ea5e9" />
            {/* Z */}
            <path d="M52 40 H 67 L 52 68 H 67" stroke="#0ea5e9" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
        </g>
        <line x1="25" y1="80" x2="75" y2="20" stroke="rgba(14, 165, 233, 0.2)" strokeWidth="1" />
    </svg>
);
